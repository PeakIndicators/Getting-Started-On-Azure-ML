...
1. In the Jupyter home page, browse to the Users/labs folder where you cloned the notebook repository, and open the **Create-Real-Time-Inferencing_service.ipynb** notebook.
