...
1. In the Jupyter home page, browse to the Users/<user_name>/labs folder where you cloned the notebook repository and open the **Run-Experiments.ipynb** notebook.
...
_Source: https://docs.microsoft.com/en-gb/azure/machine-learning/how-to-track-experiments, https://docs.microsoft.com/en-gb/azure/machine-learning/how-to-track-designer-experiments and https://docs.microsoft.com/en-us/python/api/azureml-core/azureml.core.run(class)?view=azure-ml-py_
