...
To run an automated machine learning experiment, you can either use the user interface in Azure Machine Learning studio (more details in [How to work with Azure Machine Learning Studio Automated ML](../Documents/Automated-ML.md)) or submit an experiment using the SDK. This tutorial will focus on using the SDK.

### Configure an automated machine learning experiment using the SDK
...
Automated machine learning is designed to enable you to simply bring your data and have Azure Machine Learning figuring out how best to train a model from it.
