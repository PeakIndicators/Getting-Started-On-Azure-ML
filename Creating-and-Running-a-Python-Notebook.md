...
Also in this tutorial we provide with some python templates. Please check [JupyterLab notebook templates](https://github.com/felicity-borg/Getting-Started-On-Azure-ML/tree/main/labs).
